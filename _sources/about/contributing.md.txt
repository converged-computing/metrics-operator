...
When contributing to the Metrics Operator, it is important to properly communicate the gist of the contribution.
...
For contributing to documentation, see our [Developer Guide](https://converged-computing.github.io/metrics-operator/development/developer-guide.html#documentation).
If you have any questions, please don't hesitate to [open an issue](https://github.com/converged-computing/metrics-operator/issues).
